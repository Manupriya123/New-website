    ...
    <>
      ...
      >
        <li onClick={() => handleOnClick(1)}>
          <a className={activeIndex === 1 ? "active" : ""}>Blogs</a>
        </li>
        <li onClick={() => handleOnClick(2)}>
          <a className={activeIndex === 2 ? "active" : ""}>Articles</a>
        </li>
        <li onClick={() => handleOnClick(3)}>
          <a className={activeIndex === 3 ? "active" : ""}>Gallery</a>
        </li>
        <li onClick={() => handleOnClick(4)}>
          <a className={activeIndex === 4 ? "active" : ""}>Videos</a>
        </li>
        <li onClick={() => handleOnClick(5)}>
          <a className={activeIndex === 5 ? "active" : ""}>Podcast</a>
        </li>
      </ul>
